...
class ArrayDrills {
    ...
    /**
     * Takes in two parameters (value then array), returns an array in the same
     * order it was input containing no instances of the value.
     */
    remove() {
     ...
     * of the return array)
     * (e.g. - parameter [0, 1, [2], [[3], [4]]] will return [0, 1, 2, 3, 4])
     */
    flatten() {
